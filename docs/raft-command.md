# DTGProxy Raft Command Wire Format
...
MiB, and all eight current Keyspace tags remain unchanged.
...
- Any format identifier other than the current one, nonzero flags, unknown body or mutation tags,
  and unknown Keyspace tags fail closed.
