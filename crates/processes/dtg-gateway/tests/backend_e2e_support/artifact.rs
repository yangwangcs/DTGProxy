...
const REQUEST_METRIC_DETAILS_V10: [&str; 40] = [
    "gateway_query_request_encode",
    "gateway_query_response_collect",
    "gateway_query_response_decode",
    "gateway_query_local_materialize",
...
const REQUEST_METRIC_DETAILS_V11: [&str; 41] = [
    "gateway_query_request_encode",
    "gateway_query_response_collect",
    "gateway_query_response_decode",
    "gateway_query_local_materialize",
...
const REQUEST_METRIC_DETAILS_V12: [&str; 43] = [
    "gateway_query_request_encode",
    "gateway_query_response_collect",
    "gateway_query_response_decode",
    "gateway_query_local_materialize",
...
const REQUEST_METRIC_DETAILS_V13: [&str; 44] = [
    "gateway_query_request_encode",
    "gateway_query_response_collect",
    "gateway_query_response_decode",
    "gateway_query_local_materialize",
...
const REQUEST_METRIC_DETAILS_V14: [&str; 45] = [
    "gateway_query_request_encode",
    "gateway_query_response_collect",
    "gateway_query_response_decode",
    "gateway_query_local_materialize",
...
fn validate_metrics_snapshot(
    ...
    if snapshot.schema_version == 1 {
        ...
        let expected_details: &[&str] = match snapshot.schema_version {
            ...
            10 => &REQUEST_METRIC_DETAILS_V10,
            11 => &REQUEST_METRIC_DETAILS_V11,
